> Copied verbatim from the legacy extension repo (chrome-image-storage, docs/native-app-requirements.md)
> on 2026-09-06, since that repo is being archived. The monorepo name chosen from the §11 shortlist is `boorubox`.
